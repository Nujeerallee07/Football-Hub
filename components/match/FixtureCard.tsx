// components/match/FixtureCard.tsx
      ...
      <div className={cn("p-4", compact && "p-3")}>
        ...
        <div className="space-y-2">
          ...
          <TeamRow
            ...
            goals={isUpcoming ? null : goals.home}
          ...
          <TeamRow
            ...
            goals={isUpcoming ? null : goals.away}
            winner={teams.away.winner}
            isLive={isLive}
          />
        </div>

        {/* Footer: Kick-off time or venue */}
        {(isUpcoming || compact === false) && (
          <div className="mt-3 pt-3 border-t border-neutral-700/40 flex items-center justify-between">
            {isUpcoming && (
              <span className="text-grass-400 text-xs font-semibold">
                KO: {formatKickOff(fixture.date)}
              </span>
            )}
    ...
    <div className="flex items-center justify-between gap-3">
      <div className="flex items-center gap-2.5 flex-1 min-w-0">
        ...
        <span
          className={cn(
            "text-sm truncate",
            winner ? "text-white font-semibold" : "text-neutral-300"
          )}
        >
          {name}
        </span>
