  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="flex h-1.5 rounded-full overflow-hidden bg-pitch-700">
        <div
          className="bg-grass-500 transition-all duration-500"
          style={{ width: `${hp}%` }}
        />
        <div
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 text-center">
      ...
      {onRetry && (
        <button
          onClick={onRetry}
          className="flex items-center gap-2 px-4 py-2 bg-pitch-700 hover:bg-pitch-600 text-white text-sm rounded-lg transition-colors"
        >
...
export function TabNav({ tabs, activeTab, onChange, className }: TabNavProps) {
  return (
    <div
      className={cn(
        "flex gap-1 p-1 bg-pitch-800 rounded-xl border border-neutral-700/50",
        className
      )}
    >
      {tabs.map((tab) => (
