...
export interface Fixture {
  ...
  date: string;
  timestamp: number;
  status: { long: string; short: FixtureStatus; elapsed?: number };
  venue?: Venue;
}
...
// --- Odds ---
export interface OddsMarket { name: string; values: OddsValue[] }
export interface OddsValue { value: string; odd: string }
export interface BookmakerOdds { id: number; name: string; bets: OddsMarket[] }
export interface MatchOdds { fixture: { id: number }; bookmakers: BookmakerOdds[] }
