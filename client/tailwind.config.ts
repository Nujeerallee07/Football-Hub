...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "pitch-gradient": "linear-gradient(180deg, #0a1628 0%, #050a0e 100%)",
        "card-gradient": "linear-gradient(135deg, #0f2040 0%, #0a1628 100%)",
        "live-gradient": "linear-gradient(90deg, #c62828 0%, #e53935 100%)",
        "grass-gradient": "linear-gradient(90deg, #00c853 0%, #00e676 100%)",
      },
      animation: {
